...
const Work = () => {
  return (
    <div>
        ...
        <div className='grid lg:grid-cols-4 lg:grid-rows-3 md:grid-cols-3 md:grid-rows-4 sm:grid-cols-2 sm:grid-rows-3 grid-cols-1 grid-rows-6 py-12 md:gap-4 gap-1 mx-20'>
            <Card 
            imgSrc={cysic}
