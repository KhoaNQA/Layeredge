  ...
  return (
    <div className='fixed top-0 left-0 w-full z-50 navbar'>
      <div className='w-full h-[100px] md:px-20 px-10'>
        <div className='md:max-w-[1480px] w-full mx-auto h-full flex justify-between items-center px-5 sm:px-10'>
          ...
          <div className='hidden xl:flex' >
            <ul className='flex items-center gap-10 text-white text-base'>
                ...
                <button className='btn-lightnode px-5 py-2 rounded-full bg-black text-white border'>Run a light node</button>
            </ul>
          </div>
